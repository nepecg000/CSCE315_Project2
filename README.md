# AggiePass
This Project was made using React, and thus has React App Documentation. Currently, running npm start will generate the front end but there is not yet any integration with the back end, as that is intended for sprint 2. The pre-generated documentation should give a good explanation of how to run the app.

##To Run
To each command in 2 different terminals
php -S 0.0.0.0:3001
bash start.sh
